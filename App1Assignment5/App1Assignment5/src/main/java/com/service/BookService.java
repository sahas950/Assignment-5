...
public class BookService {
	...
	public List<Book> retrieveBooks() {
		...
		try {
			URL url = new URL("http://localhost:8080/App2Assignment5/book");
			...
			for (int i = 0; i < jsonarr.size(); i++) {
				...
				String bookCode = (String) jsonobj.get("bookCode");
			...
			System.out.println("Yhaaa dusri exception aa rhii");
			e.printStackTrace();
		}
	...
	public void deleteBook(String bookcode) {
		...
		try {
			URL url = new URL("http://localhost:8080/App2Assignment5/book/" +bookcode);
			// Parse URL into HttpURLConnection in order to open the connection in order to
			// get the JSON data
			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			// Set the request to GET or POST as per the requirements
	...
	public String saveBook(Book book,String method) {
		...
		String query_url = "http://localhost:8080/App2Assignment5/book";
