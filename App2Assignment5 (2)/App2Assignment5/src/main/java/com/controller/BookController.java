...
public class BookController 
{
	...
	public void addBook(@RequestBody Book book)
	{
		...
		{
			System.out.println("BookCode must be unique..");
		}
	}
	...
	public Optional<Book> getBook(@PathVariable("bookCode") String bookCode)
	{
	...
	public void deleteBook(@PathVariable("bookCode") String bookCode)
	{
